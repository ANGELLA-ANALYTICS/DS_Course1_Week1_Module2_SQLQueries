...
# CodeGrade step7
# Replace None with your code
df_hungry_ages = pd.read_sql("""SELECT name, age, hungry FROM dogs WHERE hungry = 1 AND age >= 2 AND age <= 7 ORDER BY name ASC;""", conn2)
...
# CodeGrade step8
# Replace None with your code
df_4_oldest = pd.read_sql("""SELECT name, age, breed FROM (SELECT * FROM dogs ORDER BY age DESC LIMIT 4) ORDER BY breed ASC, name ASC;""", conn2)
